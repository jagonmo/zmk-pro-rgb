...
/* ---- 8-bit sine LUT (0-255 domain -> 0-255 range, centered at 128) ----
 * Used in place of linear triangle ramps so brightness/hue "breathing"
 * accelerates and decelerates like a natural oscillation instead of
 * moving at constant speed and reversing sharply at the peaks. All
 * integer math, no libm dependency — same style as rgbp_hsb() above. */
